...
export const puzzles: Puzzle[] = [
...

  {
    ...
    environment: 'street',
    backgroundImage: 'puzzle1-bg.svg',
obstacles: [
...
exitZone: { x: 216, y: 146, angle: 45, parkingType: 'angled' },
...

  {
    ...
    question: 'Drive out without hitting another car.',
    environment: 'street',
    backgroundImage: 'puzzle2-bg.svg',
  obstacles: [
...
exitZone: { x: 74, y: 72, angle: 270, parkingType: 'perpendicular' },
...

  {
    ...
    question: 'Drive out without hitting another car.',
    environment: 'street',
    backgroundImage: 'puzzle3-bg.svg',
    obstacles: [
...
exitZone: { x: 106, y: 95, angle: 0, parkingType: 'parallel' },
...

  {
    ...
    question: 'Drive out without hitting another car.',
    environment: 'street',
    backgroundImage: 'puzzle4-bg.svg',
   obstacles: [
...
exitZone: { x: 218, y: 208, angle: 45, parkingType: 'parallel' },
...

  {
    ...
    question: 'Drive out without hitting another car.',
    environment: 'street',
    backgroundImage: 'puzzle5-bg.svg',
   obstacles: [
...
exitZone: { x: 181, y: 152, angle: 90, parkingType: 'parallel' },
...

  {
    ...
    question: 'Drive out without hitting another car.',
    environment: 'garage',
    backgroundImage: 'puzzle6-bg.svg',
   obstacles: [
...
exitZone: { x: 52, y: 234, angle: 0, parkingType: 'parallel' },
...

  {
    ...
    question: 'Drive out without hitting another car.',
    environment: 'garage',
    backgroundImage: 'puzzle7-bg.svg',
    obstacles: [
...
exitZone: { x: 117, y: 215, angle: 315, parkingType: 'parallel' },
...

  {
    ...
    question: 'Drive out without hitting another car.',
    environment: 'garage',
    backgroundImage: 'puzzle8-bg.svg',
    obstacles: [
...
exitZone: { x: 214, y: 72, angle: 135, parkingType: 'angled' },
...

  {
    ...
    question: 'Drive out without hitting another car.',
    environment: 'garage',
    backgroundImage: 'puzzle9-bg.svg',
   obstacles: [
...
exitZone: { x: 148, y: 112, angle: 135, parkingType: 'angled' },
...

  {
    ...
    question: 'Drive out without hitting another car.',
    environment: 'garage',
    backgroundImage: 'puzzle10-bg.svg',
   obstacles: [
...
exitZone: { x: 63, y: 72, angle: 0, parkingType: 'perpendicular' },
...

  {
    ...
    backgroundImage: 'puzzle11-bg.svg',
    obstacles: [
...
exitZone: { x: 215, y: 200, angle: 180, parkingType: 'perpendicular' },
...

  {
    ...
    question: 'Drive out without hitting another car.',
    environment: 'open_lot',
    backgroundImage: 'puzzle12-bg.svg',
   obstacles: [
...
exitZone: { x: 198, y: 134, angle: 90, parkingType: 'parallel' },
...

  {
    ...
    question: 'Drive out without hitting another car.',
    environment: 'open_lot',
    backgroundImage: 'puzzle13-bg.svg',
   obstacles: [
...
exitZone: { x: 227, y: 100, angle: 315, parkingType: 'angled' },
...

  {
    ...
    question: 'Drive out without hitting another car.',
    environment: 'open_lot',
    backgroundImage: 'puzzle14-bg.svg',
   obstacles: [
...
exitZone: { x: 123, y: 223, angle: 315, parkingType: 'angled' },
...

  {
    ...
    question: 'Drive out without hitting another car.',
    environment: 'open_lot',
    backgroundImage: 'puzzle15-bg.svg',
   obstacles: [
