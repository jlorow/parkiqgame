...
obstacles: [
  { type: 'sedan', x: 201, y: 215, angle: 90 },
  { type: 'suv', x: 77, y: 211, angle: 270 },
  { type: 'sedan', x: 75, y: 143, angle: 270 },
  { type: 'suv', x: 205, y: 147, angle: 90 },
  { type: 'tree-sm', x: 259, y: 178, angle: 0 },
  { type: 'tree-sm', x: 32, y: 178, angle: 0 },
  { type: 'tree-sm', x: 27, y: 101, angle: 0 },
],
playerCar: { x: 133, y: 257, angle: 45 },
exitZone: { x: 214, y: 74, angle: 90, parkingType: 'perpendicular' },
    escapeSteps: [
  ...
  obstacles: [
  { type: 'tree-sm', x: 61, y: 106, angle: 0 },
  { type: 'tree-sm', x: 127, y: 61, angle: 0 },
  { type: 'sedan', x: 164, y: 87, angle: 0 },
  { type: 'suv', x: 108, y: 125, angle: 0 },
  { type: 'tree-sm', x: 224, y: 263, angle: 0 },
],
playerCar: { x: 48, y: 247, angle: 45 },
exitZone: { x: 234, y: 139, angle: 180, parkingType: 'parallel' },
    escapeSteps: [
...
exitZone: { x: 201, y: 222, angle: 45, parkingType: 'angled' },
...

  {
   ...
   obstacles: [
  { type: 'tree-sm', x: 60, y: 103, angle: 0 },
  { type: 'tree-sm', x: 65, y: 184, angle: 0 },
  { type: 'sedan', x: 72, y: 62, angle: 270 },
  { type: 'suv', x: 218, y: 61, angle: 270 },
  { type: 'wall', x: 263, y: 97, angle: 0 },
  { type: 'wall', x: 264, y: 194, angle: 0 },
  { type: 'suv', x: 72, y: 143, angle: 270 },
],
playerCar: { x: 142, y: 264, angle: 0 },
exitZone: { x: 197, y: 143, angle: 270, parkingType: 'parallel' },
...
exitZone: { x: 237, y: 246, angle: 180, parkingType: 'parallel' },
...

  {
    ...
    environment: 'garage',
    obstacles: [
  { type: 'tree-sm', x: 210, y: 180, angle: 0 },
  { type: 'tree-sm', x: 80, y: 176, angle: 0 },
  { type: 'tree-sm', x: 79, y: 95, angle: 0 },
  { type: 'suv', x: 114, y: 232, angle: 330 },
  { type: 'suv', x: 118, y: 167, angle: 330 },
  { type: 'sedan', x: 170, y: 238, angle: 45 },
],
playerCar: { x: 249, y: 251, angle: 0 },
exitZone: { x: 175, y: 91, angle: 45, parkingType: 'angled' },
    escapeSteps: [
...
exitZone: { x: 179, y: 242, angle: 270, parkingType: 'perpendicular' },
    escapeSteps: [
...
exitZone: { x: 193, y: 79, angle: 90, parkingType: 'perpendicular' },
    escapeSteps: [
...
exitZone: { x: 159, y: 101, angle: 315, parkingType: 'angled' },
  ...
  obstacles: [
  { type: 'tree-sm', x: 68, y: 159, angle: 0 },
  { type: 'sedan', x: 119, y: 219, angle: 315 },
  { type: 'suv', x: 120, y: 147, angle: 315 },
  { type: 'tree-sm', x: 65, y: 101, angle: 0 },
],
playerCar: { x: 242, y: 251, angle: 90 },
exitZone: { x: 124, y: 81, angle: 315, parkingType: 'angled' },
    escapeSteps: [
 ...
 obstacles: [
  ...
  { type: 'tree-sm', x: 32, y: 253, angle: 0 },
